...
export const DEFAULT_DOOR_ESTIMATOR_CONFIG: DoorEstimatorConfig = {
  ...
  ].map(([code, publicName, category, description, constructionCodes, finishTiers, windowGroup]) => ({ code, publicName, category, description, imagePath: "", constructionCodes, finishTiers, windowGroup, websiteEnabled: true, fieldEnabled: true, active: true })) as DoorEstimatorConfig["styles"],
  colors: [
  ...
  openers: [
    ...
    { code:"quiet-belt", publicName:"Quiet Belt Drive", description:"Quieter operation for attached garages.", features:["Quiet belt drive","Smartphone control"], costsByHeight:{7:408.65,8:449.34,9:503.08}, websiteEnabled:true, fieldEnabled:true, active:true },
