...
export const DEFAULT_DOOR_ESTIMATOR_CONFIG: DoorEstimatorConfig = {
  ...
  distributorName: "Westwinds Wholesale Doors — DoorLink residential price sheets effective 5/4/2026 (preliminary)",
  internalNotes: "Finish column key — standard: WHT/ALM/SAND/DTAN/BRN/BLK/CHAR price column · wood: Walnut/woodgrain column (essential/comfort = 420–480 walnut; premium = 3620–3680 Driftwood/Oak/Walnut) · plank: DoorLink 3700 Ozark column.",
  constructions: [
    { code: "essential", publicName: "Essential Steel", eyebrow: "Best value", description: "A durable non-insulated steel door for homeowners who want the lowest initial price.", specifications: ["Heavy-duty exterior steel", "Two-inch sections", "Reinforced hardware attachment points", "Replaceable bottom seal"], rValue: null, finishTiers: ["standard", "wood"], active: true, internalRef: "DoorLink 410–490 non-insulated pan (24 ga)" },
    { code: "comfort", publicName: "Comfort Insulated", eyebrow: "Quieter and more comfortable", description: "An insulated steel door with quieter operation and improved temperature control.", specifications: ["Heavy-duty exterior steel", "Polystyrene insulation", "Finished vinyl interior backing", "Approximately R-6.85"], rValue: 6.85, finishTiers: ["standard", "wood"], active: true, internalRef: "DoorLink 411–491 vinyl-back insulated (R-6.85)" },
    { code: "premium", publicName: "Premium Steel-Back", eyebrow: "Strongest and quietest", description: "A steel-interior insulated door with improved strength, sound reduction, and a clean finished interior.", specifications: ["Steel exterior and interior", "Two-inch insulated construction", "Full-height reinforcement", "Approximately R-10.25"], rValue: 10.25, finishTiers: ["standard", "wood", "plank"], active: true, internalRef: "DoorLink 3610–3690 / 3700 steel-back sandwich (R-10.25)" },
  ],
  styles: [
  ...
  openers: [
    { code:"keep-existing", publicName:"Keep Existing Opener", description:"Reconnect the existing opener when compatible.", features:["Compatibility confirmed on-site"], costsByHeight:{7:0,8:0,9:0}, websiteEnabled:true, fieldEnabled:true, active:true, internalRef:"No part — reconnect only" },
    { code:"reliable-chain", publicName:"Reliable Chain Drive", description:"Dependable smart opener for everyday use.", features:["Smartphone control","Safety sensors"], costsByHeight:{7:300.27,8:337.2,9:398.96}, websiteEnabled:true, fieldEnabled:true, active:true, internalRef:"LiftMaster 2220L (7'/8'/10' rail)" },
    { code:"battery-belt", publicName:"Belt Drive with Battery Backup", description:"Quiet operation with backup power.", features:["Battery backup","Smartphone control"], costsByHeight:{7:506.45,8:544.75,9:632.55}, websiteEnabled:true, fieldEnabled:true, active:true, internalRef:"LiftMaster 87504-267 (7'/8'/10' rail)" },
    { code:"premium-smart", publicName:"Premium Smart Opener", description:"Premium lighting and battery backup.", features:["Battery backup","Premium lighting"], costsByHeight:{7:557.64,8:598.34,9:652.08}, websiteEnabled:true, fieldEnabled:true, active:true, internalRef:"LiftMaster 6690L (7'/8'/10' rail)" },
    { code:"wall-mount", publicName:"Space-Saving Wall-Mount", description:"Mounts beside the door to free ceiling space.", features:["Compatibility required"], costsByHeight:{7:659.15,8:659.15,9:659.15}, websiteEnabled:false, fieldEnabled:true, active:true, internalRef:"LiftMaster 98022 wall-mount (no rail)" },
  ],
  priceRows,
}
